 ...
 * @ORM\Entity
 */
class Records extends \Bosh\CoreBundle\Service\AbstractEntity
{
    /**
     * @var string
     *
    ...
    /**
     * @var \Bosh\CoreBundle\Entity\Domains
     *
     * @ORM\ManyToOne(targetEntity="Bosh\CoreBundle\Entity\Domains")
     * @ORM\JoinColumns({

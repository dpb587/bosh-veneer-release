 ...
 * @ORM\Entity
 */
class RenderedTemplatesArchives extends \Bosh\CoreBundle\Service\AbstractEntity
{
    /**
     * @var string
     *
    ...
    /**
     * @var \Bosh\CoreBundle\Entity\Instances
     *
     * @ORM\ManyToOne(targetEntity="Bosh\CoreBundle\Entity\Instances")
     * @ORM\JoinColumns({
